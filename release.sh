...
# Output: dist/combat_log-<version>.zip with this structure:
#   combat_log/manifest.json
#   combat_log/preview.png (if present)
#   combat_log/assembly/common/CombatLog.dll
set -euo pipefail

cd "$(dirname "$0")"

MOD_ID="combat_log"
ASSEMBLY_NAME="CombatLog"
TFM="netstandard2.1"
